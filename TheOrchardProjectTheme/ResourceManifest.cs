...
namespace OrchardCore.Themes.TheOrchardProjectTheme
{
    public class ResourceManifest : IResourceManifestProvider
    {
        public void BuildManifests(IResourceManifestBuilder builder)
        {
            ...
            manifest
                ...
                .SetUrl("~/TOPT/vendor/jquery/jquery.min.js", "~/TOPT/vendor/jquery/jquery.js")
            ...
            manifest
                ...
                .SetUrl("~/TOPT/vendor/jquery/jquery.slim.min.js", "~/TOPT/vendor/jquery/jquery.slim.js")
            ...
            manifest
                .DefineScript("vendor-jQuery.easing")
                .SetDependencies("vendor-jQuery")
                .SetUrl("~/TOPT/vendor/jquery-easing/jquery.easing.min.js", "~/TOPT/vendor/jquery-easing/jquery.easing.js")
            ...
            manifest
                ...
                .SetDependencies("vendor-jQuery")
                .SetUrl("~/TOPT/vendor/bootstrap/js/bootstrap.min.js", "~/TOPT/vendor/bootstrap/js/bootstrap.js")
            ...
            manifest
                ...
                .SetDependencies("vendor-jQuery")
                .SetUrl("~/TOPT/vendor/bootstrap/js/bootstrap.bundle.min.js", "~/TOPT/vendor/bootstrap/js/bootstrap.bundle.js")
            ...
            manifest
                ...
                .SetUrl("~/TOPT/vendor/bootstrap/css/bootstrap.min.css", "~/TOPT/vendor/bootstrap/css/bootstrap.css")
            ...
            manifest
                ...
                .SetUrl("~/TOPT/vendor/fontawesome-free/css/all.min.css", "~/TOPT/vendor/fontawesome-free/css/all.css")
